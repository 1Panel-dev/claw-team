          ...
          >
            ...
            >
              ...
              <span class="file-section__header-actions">
                ...
                <el-icon class="file-section__arrow" :class="{ 'file-section__arrow--open': fileExpandedState[fileField.key] }">
                  <ArrowDown />
                </el-icon>
              </span>
            </button>
    ...
    <template #footer>
      <div class="drawer-actions">
        ...
        <el-button type="primary" :loading="submitting" :disabled="!canSubmit" @click="submit">
          {{ isEditMode ? t("openclaw.saveAgent") : t("openclaw.createAgent") }}
        </el-button>
      </div>
    </template>
  </el-drawer>
...
const drawerTitle = computed(() =>
    isEditMode.value
        ...
        : t("openclaw.agentDrawerTitle", { name: props.instanceName }),
);
const drawerHint = computed(() =>
    isEditMode.value ? t("openclaw.agentDrawerEditHint") : t("openclaw.agentDrawerHint"),
);
